...
export default function MentorSignup({ theme, setTheme }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      sendConfirmationEmail(emailToCheck, formData.firstName.trim(), 'mentor');
          ...
          {currentPage === 1 && (
            <div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <label className="block mb-2 text-theme-primary">
                    List 1-3 hobbies or skills you have experience with.
                  </label>
                  <textarea
                    name="hobbies"
                    value={formData.hobbies}
                    onChange={handleInputChange}
                    placeholder="(e.g, Guitar, Muay-Thai, Sewing, etc.)"
                    rows="6"
